...
public class PhoneAuth extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        minimalKSnack = new MinimalKSnack(PhoneAuth.this);
        v1=findViewById(R.id.fieldPhoneNumber);
        v2=findViewById(R.id.fieldVerificationCode);
        v3=findViewById(R.id.buttonStartVerification);
        v4=findViewById(R.id.buttonVerifyPhone);
        v5=findViewById(R.id.buttonResend);
        CountryCodePicker ccp;
        AppCompatEditText edtPhoneNumber;


        v6=findViewById(R.id.textView2);
        Flubber.with()
        ...
        mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationFailed(FirebaseException e) {
                ...
                if (e instanceof FirebaseAuthInvalidCredentialsException) {
                    ...
                    // [START_EXCLUDE]
                    Toast.makeText(PhoneAuth.this, "Limit Ecxeeded please Login with other options", Toast.LENGTH_SHORT).show();
                    // [END_EXCLUDE]
                }
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(PhoneAuth.this, "Login succeded", Toast.LENGTH_SHORT).show();
...
//                mDetailText.setText(null);
            ...
            case STATE_CODE_SENT:
                ...
                minimalKSnack
                        .setMessage("OTP SENT") // message
                        .setStyle(MinimalKSnackStyle.STYLE_SUCCESS) // style
                        .setBackgroundColor(R.color.colorAccent) // background color
...
//            mSignedInViews.setVisibility(View.VISIBLE);
         ...
         //   mPhoneNumberField.setText(null);
            ...
            Intent myIntent = new Intent(PhoneAuth.this, MainActivity.class);
            myIntent.putExtra("login","phone");
            PhoneAuth.this.startActivity(myIntent);
        ...
        switch (view.getId()) {
            case R.id.buttonStartVerification:
                timer = new CountDownTimer(3000, 5000)
                {
                    ...
                    {
                        progress = new ProgressDialog(PhoneAuth.this);
